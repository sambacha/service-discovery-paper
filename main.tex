...
\title{\sysname: Robust, efficient, and decentralized\\service discovery in the Ethereum platform}
\author{Anonymous authors, submission \#XXX}
...
\input{sections/intro_Etienne}

%\input{sections/background}
%\input{sections/background_high_level}
\input{sections/new_background}
