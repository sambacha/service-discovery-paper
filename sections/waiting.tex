...
higher returned waiting times and lower average occupancy of the topic table.\mk{TODO:refer to the analysis when it's done}
...
With the current occupancy $d$ close to the capacity of the table $n$, the \emph{occupancy score} goes to infinity thus limiting the number of admitted requests.\mk{the above might go to the analysis}
