...
\michal{Need an alg for the IP tree}
...
Each request is given a waiting time based on the IP address of the advertiser, the topic of the request, and the current state of the ad cache.
