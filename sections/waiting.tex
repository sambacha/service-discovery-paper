...
With the current occupancy $d$ close to the capacity of the cache $n$, the \emph{occupancy score} goes to infinity thus limiting the number of admitted requests. We analyze the behavior of the waiting function and choose optimal system parameter values in \Cref{sec:analysis}.
...
The similarity score for topics is given by:
\begin{equation}
\label{eq:similarity}
...
\begin{figure}
    \includegraphics[width=0.45\textwidth]{img/ip_tree_small}
    \vspace{-0.05in}
