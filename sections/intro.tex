...
A \emph{sub-network} enables the exchange of application-specific data such as transactions and blocks uniquely between the peers interested in that data. In 2018, the Ethereum P2P network nodes operated a total of 4,076 different applications~\cite{kim2018measuring}, and this number is expected to grow(\Cref{fig:ecosystem}).
