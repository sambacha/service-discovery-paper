...
\onur{need to clarify the distinction between an application and a service. An application can run multiple services, each potentially requiring a dedicated sub-network} 
...
\felix{Is this claim really true? Log complexity search for all topics?}
