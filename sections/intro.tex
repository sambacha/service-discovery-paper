...
\michal{As Onur suggested, we should discuss more the advantages of having a large, common network to start with (rather than build a seperate one for each app)}
