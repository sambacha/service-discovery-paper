...
\end{itemize}
The tickets are digitally signed by the issuing advertiser. \er{should we give more details here? What is the purpose? Do we assume the registrar knows the public key of the advertiser, always, so it can check this signature?}
