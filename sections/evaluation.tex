...
In Figure~\ref{fig:eclipse_distribution_t0} we show the malicious nodes discovered for all lookups for all protocols using different using different number of Sybil nodes,  when attacking the most popular topic,  and in Figure~\ref{fig:eclipse_distribution_t299} whe show the malicious nodes discovered for the least popular topic.
