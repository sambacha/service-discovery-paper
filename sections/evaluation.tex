...
\begin{figure}[!h]
\includegraphics[width=\linewidth]{results/efficiency/bar_topic_lookupMsgs.png}
...
\begin{figure}[!h]
\includegraphics[width=\linewidth]{results/efficiency/bar_topic_registrationMsgs.png}
\caption{Y-axis: Average and standard deviation of the number of lookup-related messages (received/sent) by peers for varying number of topics.} 
\label{fig:regMsgsPerTopicSize}
\end{figure}

\begin{figure}[!h]
\includegraphics[width=\linewidth]{results/efficiency/bar_topic_lookupAskedNodes.png}
...
\begin{figure}[!h]
\includegraphics[width=\linewidth]{results/efficiency/bar_topic_discovered.png}
...
\begin{figure}[!h]
\includegraphics[width=\linewidth]{results/efficiency/bar_topic_wasDiscovered.png}
