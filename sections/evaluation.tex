...
This is caused by the fact that with more nodes trying to register for the same topic, waiting times increase and therefore is more difficult to register.\michal{This still doesn't make sense to me. The waiting times are calculated based on the content already inside the table rather than pending registrations.}
...
\centering
%\epsfig{file=imgs/eval/scen5.pdf, width=0.45\textwidth}
\includegraphics[width=0.35\textwidth]{img/eval/lookup_hopcount.eps}
