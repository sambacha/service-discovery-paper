...
\michal{We should show results allowing to find optimal values for:, $b$, $P_\textit{occupancy}$, $P_\textit{topic}$, $P_\textit{ID}$,   $P_\textit{IP}$ }



\subsection{Efficiency}
\michal{Should we implement LRU with DHT?}
