...
\includegraphics[width=0.3\textwidth]{results/efficiency/violin_topic_lookupMsgs}
...
\includegraphics[width=0.3\linewidth]{results/efficiency/violin_topic_discovered}
...
\includegraphics[width=0.3\linewidth]{results/efficiency/violin_topic_wasDiscovered}
\label{fig:askedNodesPerTopicSize}
}
...
\includegraphics[width=0.3\textwidth]{results/efficiency/violin_size_lookupMsgs}
\label{fig:lookupMsgsPerTopicSize}
}
\subfigure[{Y-axis: Distribution of the number of peers discovered during lookup operation for different network size.}]{
\includegraphics[width=0.3\linewidth]{results/efficiency/violin_size_discovered}
\label{fig:askedNodesPerTopicSize}
}
\subfigure[{Y-axis: Distribution of the number of times a peer is discovered by others for different network size.}]{
\includegraphics[width=0.3\linewidth]{results/efficiency/violin_size_wasDiscovered}
\label{fig:askedNodesPerTopicSize}
}
\caption{Efficiency performance for different topic number} 
\label{fig:mptcp}
