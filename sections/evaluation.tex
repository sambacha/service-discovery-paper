...
Plots for varying number of topics with 21,000 nodes (using DNS list records obtained from crawling the Ethereum DHT). 

\begin{figure*}[!h]
\centering
\subfigure[{Y-axis: Distribution of discovery related (including registration and lookup) messages received by peers for varying number of topics.}]{
\includegraphics[width=0.32\textwidth]{results/efficiency/violin_topic_totalMsg.eps}
\label{fig:lookupMsgsPerTopicSize}
}
\subfigure[{Y-axis: Distribution of the number of peers discovered during lookup operation for varying number of topics.}]{
\includegraphics[width=0.32\linewidth]{results/efficiency/violin_topic_discovered.eps}
\label{fig:askedNodesPerTopicSize}
}
\subfigure[{Y-axis: Distribution of the number of times a peer is discovered by others for varying number of topics.}]{
\includegraphics[width=0.32\linewidth]{results/efficiency/violin_topic_wasDiscovered.eps}
\label{fig:askedNodesPerTopicSize}
}
\caption{Efficiency performance for different topic number} 
\label{fig:efficiency_topic}
\vspace{-0.05in}
\end{figure*}
...
\begin{figure*}[!h]
\centering
\subfigure[{Y-axis: Distribution of discovery related (including registration and lookup) messages received by peers for different network size.}]{
\includegraphics[width=0.32\textwidth]{results/efficiency/violin_size_totalMsg.eps}
\label{fig:lookupMsgsPerTopicSize}
}
\subfigure[{Y-axis: Distribution of the number of peers discovered during lookup operation for different network size.}]{
\includegraphics[width=0.32\linewidth]{results/efficiency/violin_size_discovered.eps}
\label{fig:askedNodesPerTopicSize}
}
\subfigure[{Y-axis: Distribution of the number of times a peer is discovered by others for different network size.}]{
\includegraphics[width=0.32\linewidth]{results/efficiency/violin_size_wasDiscovered.eps}
\label{fig:askedNodesPerTopicSize}
}
\caption{Efficiency performance for different network size} 
\label{fig:efficiency_size}
\vspace{-0.05in}
\end{figure*}

%\begin{figure}[!h]
%\includegraphics[width=\linewidth]{results/efficiency/violin_topic_lookupMsgs}
%\caption{Y-axis: Average and standard deviation of the number of lookup-related messages (received/sent) by peers for varying number of topics.} 
%\label{fig:lookupMsgsPerTopicSize}
%\end{figure}
%
%\begin{figure}[!h]
%\includegraphics[width=\linewidth]{results/efficiency/violin_topic_registrationMsgs}
%\caption{Y-axis: Average and standard deviation of the number of lookup-related messages (received/sent) by peers for varying number of topics.} 
%\label{fig:regMsgsPerTopicSize}
%\end{figure}
%
%\begin{figure}[!h]
%\includegraphics[width=\linewidth]{results/efficiency/violin_topic_lookupAskedNodes}
%\caption{Y-axis: Average and standard deviation of the number of peers contacted per lookup operation for varying number of topics.} 
%\label{fig:askedNodesPerTopicSize}
%\end{figure}
%
%\begin{figure}[!h]
%\includegraphics[width=\linewidth]{results/efficiency/violin_topic_discovered}
%\caption{Y-axis: Average and standard deviation of the number of discovered peers per lookup operation for varying number of topics.} 
%\label{fig:wasDiscoveredPerTopicSize}
%\end{figure}
%
%\begin{figure}[!h]
%\includegraphics[width=\linewidth]{results/efficiency/violin_topic_wasDiscovered.png}
%\caption{Y-axis: Average and standard deviation of the number of times a peer is discovered by others for varying number of topics.} 
%\label{fig:wasDiscoveredPerTopicSize}
%\end{figure}
...
\para{Eclipse Attack}
We implement and evaluate \sysname resistance against a hybrid eclipse attack targeted to a specific topic,  that  tries to make a searcher node discover and connect to peers under the attacker's control.  
The attacker may be able to generate a large but finite number of sybil nodes,  with limited network resources,  such as different IP addresses.
...
\includegraphics[width=0.32\textwidth]{results/security/bar_idDistribution_percentageEclipsedLookups.eps}
\label{fig:distribution}
}
\subfigure[{Y-axis: Percentage eclipsed nodes for different number of sybil nodes in the attack.}]{
\includegraphics[width=0.32\linewidth]{results/security/bar_percentEvilTopic_percentageEclipsedLookups.eps}
\label{fig:percentEvil}
}
\subfigure[{Y-axis: Percentage eclipsed nodes for different number IP addresses used in the attack.}]{
\includegraphics[width=0.32\linewidth]{results/security/bar_sybilSize_percentageEclipsedLookups.eps}
\label{fig:sybilsize}
}
\caption{Resistance against eclipse attacks} 
