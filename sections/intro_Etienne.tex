...
\sysname is integrated in \emph{discv5}~\cite{discv5} (Node Discovery protocol version 5) a new set of P2P protocols aiming at replacing \emph{discv4} in future versions of Ethereum. \er{ideally add a reference or two here}
