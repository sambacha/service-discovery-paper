...
\ramin{Is there a way to support the above assumption? Is the power law distribution visible in existing applications? (according to the text, there are 4076)} 
