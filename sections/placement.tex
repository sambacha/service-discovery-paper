...
\label{sec:placement}
In the following, we describe distributing advertisements in the network and discuss the process of searching for, and establishing sub-protocol connections. \er{sub-protocol connections? Application-specific connections instead?} We start by discussing the challenges related to the problem and explaining the data structures used by \sysname. 
