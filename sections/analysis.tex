...
\begin{figure}[t]
	...
	\protect\er{as the value for the blue line for x=100 is not readable, we could add it as text on the figure?}\mk{good idea - will do} Parameters: $K_{register}=5, N=25000, N_a+N_b=15000, N_x=100$.}
