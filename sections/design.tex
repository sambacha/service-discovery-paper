...
\michal{It might be better to first describe the data structures used (tickets, tables) and then explain the protocol}
...
\michal{The paragraph below discusses goals that should already be presented in the overview/model.}
